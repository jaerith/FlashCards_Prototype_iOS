//
//  PrototypeTwoResultsController.m
//  BNFCPrototype
//
...
@implementation PrototypeTwoResultsController
...
- (UITableViewCell*) tableView:(UITableView*)tableView
	...
	static NSString* PTRCellIdentifier = @"PTRCellIdentifier";
	
	UITableViewCell *cell = 
	[tableView dequeueReusableCellWithIdentifier:PTRCellIdentifier];
	
	if (cell == nil){
		cell = [[[UITableViewCell alloc] initWithFrame:CGRectZero
									   reuseIdentifier:PTRCellIdentifier] autorelease];
	}
	else {
